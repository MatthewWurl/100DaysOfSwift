...
class GameScene: SKScene, SKPhysicsContactDelegate {
    ...
    func launch(angle: Int, velocity: Int) {
        ...
        if currentPlayer == 1 {
            ...
            let impulse = CGVector(dx: -1 * cos(radians) * speed, dy: sin(radians) * speed)
            banana.physicsBody?.applyImpulse(impulse)
        }
    }
    ...
    func createPlayers() {
        ...
        let player1X = player1Building.position.x
        let player1Y = player1Building.position.y + ((player1Building.size.height + player1.size.height) / 2)
        ...
        let player2X = player2Building.position.x
        let player2Y = player2Building.position.y + ((player2Building.size.height + player2.size.height) / 2)
